...
<body class="bg-light">
  ...
  <div class="py-5 bg-light">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-center display-3 text-primary">Forge Gallery</h1>
          <p class="text-center">Showcasing the very best of student projects. &nbsp;To see even more, go to our Facebook Page</p>
        </div>
      </div>
    </div>
  </div>
